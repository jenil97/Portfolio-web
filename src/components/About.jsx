...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-[100vh] md:h-[120vh] bg-[#0a192f] text-gray-300"
    >
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div>
            <p>
              ...
              some edits on a small website that I was operating. What I thought
              was just a few small edits turned into a love for programming &
              than I started my self-thought developing journey. I am now
              passionate about building excellent websites that improves the
              lives around me. Now I'm spending my time building projects in
